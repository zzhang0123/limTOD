...
# SECURITY: pickle deserialization executes arbitrary code. The operator
# caches are local build artifacts regenerated by build_mapmaker_ops.py —
# only ever load caches you created yourself. (Plain-text pickle usage was
# explicitly authorized by the maintainer; an obfuscated import that dodged
# the security hook was removed in review.)
import pickle
